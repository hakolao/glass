...
impl RectanglePipeline {
    pub fn new(device: &Device, color_target_state: wgpu::ColorTargetState) -> RectanglePipeline {
    ...
    pub fn new_render_pipeline(
        ...
        let layout = device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            ...
            push_constant_ranges: &[PushConstantRange {
                ...
                range: 0..std::mem::size_of::<RectanglePushConstants>() as u32,
            }],
        });
    ...
    pub fn draw<'r>(
        ...
        rpass.set_push_constants(
            ...
            0,
            bytemuck::cast_slice(&[RectanglePushConstants::new(
                view_proj,
                pos,
                color.color,
                width,
...
pub struct RectanglePushConstants {
